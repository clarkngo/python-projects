...
# and calls f with a and b. So the input to car and cdr is that anonymous function,
# which is pair. To get a and b back, we must feed it yet another function,
# one that takes in two parameters and returns the first (if car) or last (if cdr) one.
