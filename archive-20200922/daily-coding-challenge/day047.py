...
# Solution
# The brute force solution here is to iterate over our list of stock prices, and for each price,
# find the largest profit you can make from selling that stock price (with the formula future - current),
# and keep track of the largest profit we can find. That would look like this:
...
# The maximum profit comes from the greatest difference between the highest price and lowest price,
...
# Then, at each step, we can look at the current price and
# check how much profit we would have made buying at that price by comparing with our maximum price in the future.
